                ...
                <div class="post-section">
                    <div class="post">
                        <div class="post-header">
                            <div class="post-info">
                                <div class="post-img">
                                    <img src="{{ url('frontend/user-profiles/' . $post->user->img) }}"
                                        alt="" />
                                </div>
                        ...
                        <div class="post-footer">
                            ...
                            <form action="{{ url('comment/' . $post->id . '/' . $user->id) }}" method="POST"
                                autocomplete="off">
                                @csrf
                                ...
                                @foreach ($post->comments as $comment)
                                    <div class="show-comment">
                                        <div class="comment-info">
                                            <img src="{{ url('frontend/user-profiles/' . $comment->user->img) }}"
                                                alt="" />
                                            <div class="commentater">
                                                <p><span>{{ $comment->user->username }}</span>{{ $comment->comment }}
                                                </p>
                                                <div class="main-span">
